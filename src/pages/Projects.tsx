...
import { Github, Bot, Code2, CircuitBoard, Plane, Trophy, Zap, Wrench } from "lucide-react";
...
const Projects = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Projects | DTN</title>
        <meta name="description" content="Projects by Duc Nguyen — robotics, embedded systems, and hardware design." />
      </Helmet>
